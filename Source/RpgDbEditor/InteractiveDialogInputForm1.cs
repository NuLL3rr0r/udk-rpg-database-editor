...
{
    public partial class InteractiveDialogInputForm1 : Form
    {
        ...
        public string[] characters
        {
            set
            {
                cmbCharacterID.Items.AddRange(value);
            }
        }
        ...
        public InteractiveDialogInputForm1()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!_isEditMode)
                {
                    ...
                    dr["Character"] = cmbCharacterID.Text;
                    ...
                    dr["ActionType"] = cmbActionType.Text;
        ...
        private void InteractiveDialogInputForm1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                while (drr.Read())
                {
                    if ((int)drr["RowID"] == _dialogID)
                    {
                        cmbCharacterID.Text = drr["Character"].ToString();
                        ...
                        cmbAction.Text = drr["Action"].ToString();
                        cmbActionType.Text = drr["ActionType"].ToString();
